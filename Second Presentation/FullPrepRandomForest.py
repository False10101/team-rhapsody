...
print("\nRandom Forest model trained on v2 (full) prepared data.")
...
submission_df.to_csv('submission_rf_v2_full_prep.csv', index=False)
print("\nSubmission file 'submission_rf_v2_full_prep.csv' created.")