...
## 3. Model Training and Prediction (Scaling is NOT needed for Random Forest)
model = RandomForestRegressor(n_estimators=100, random_state=42, n_jobs=-1)
y = train_df['SalePrice']
model.fit(X_processed, y)
print("\nRandom Forest model trained successfully on v1 prepared data.")
...
submission_df.to_csv('submission_rf_v1_outliers_skew.csv', index=False)
print("\nSubmission file 'submission_rf_v1_outliers_skew.csv' created.")