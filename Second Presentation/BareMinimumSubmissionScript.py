...
# This helps normalize the skewed sale price distribution for better model performance.
...
# --- Step 4.1: Train the Ridge Regression Model ---
# We'll use a standard alpha value for this baseline.
...
# --- Step 4.3: Inverse Transform Predictions ---
